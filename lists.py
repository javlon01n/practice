...
people = ("Andrew", "FLEX", "DEVEX", "MG")  # tuple
...
print("====== list methods ======")
# method > append() .insert() .pop() .remove() .clear() .sort() .index(value)
...
size = len(letters) - 1
resualt1 = letters.pop(size)  # pop behind
print(f"the pop resualt1: {resualt1} and letters: {letters}")

resualt2 = letters.pop(0)  # pop front
print(f"the pop resualt2: {resualt2} and letters: {letters}")
